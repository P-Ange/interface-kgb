 ...
 */
final class Version20220217140700 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE missions_hiding_places (missions_id INT NOT NULL, hiding_places_id INT NOT NULL, INDEX IDX_579930EA17C042CF (missions_id), INDEX IDX_579930EA1B3F9D14 (hiding_places_id), PRIMARY KEY(missions_id, hiding_places_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE missions_hiding_places ADD CONSTRAINT FK_579930EA17C042CF FOREIGN KEY (missions_id) REFERENCES missions (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE missions_hiding_places ADD CONSTRAINT FK_579930EA1B3F9D14 FOREIGN KEY (hiding_places_id) REFERENCES hiding_places (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP TABLE missions_hiding_places');
